...
export class ApiService {
  ...
  admin = {
    ...
    toggleUserActive: (id: string, isActive?: boolean) => this.adminApi.toggleUserActive(id, isActive),
    resetUserPassword: (id: string, pwd: string) => this.adminApi.resetUserPassword(id, pwd),
    ...
    toggleBarberActive: (id: string, isActive?: boolean) => this.adminApi.toggleBarberActive(id, isActive),
    resetBarberPassword: (id: string, pwd: string) => this.adminApi.resetBarberPassword(id, pwd),
    updateBarber: (id: string, d: Record<string, unknown>) => this.adminApi.updateBarber(id, d),
    deleteBarber: (id: string) => this.adminApi.deleteBarber(id),
